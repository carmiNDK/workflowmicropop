				...
				<form action="InformationFamille.php" method="post"
					...
					<div class="ui blue segment">
						<h2 class="tw-text-lg tw-font-semibold tw-mb-2"
							style="margin-top: 15px;">Dépenses Familiales</h2>
						<hr>
						...
						<div class="ui segment" style="padding: 10px;">
							<div class="ui form">
								...
								<div class="two fields mini">
									...
									<div class="field">
										<input class="mini input" type="number"
											value="${CombustibleValue}" disabled>
									</div>
								</div>
								...
								<div class="two fields mini">
									...
									<div class="field">
										<input class="mini input" type="number" value="${LoyerValue}"
											disabled>
									</div>
								</div>
								...
								<div class="two fields mini">
									...
									<div class="field">
										<input class="mini input" type="number"
											value="${CommunicationValue}" disabled>
									</div>
								</div>
								...
								<div class="two fields mini">
									...
									<div class="field">
										<input class="mini input" type="number"
											value="${HabillementValue}" disabled>
									</div>
								</div>
								...
								<div class="two fields mini">
									...
									<div class="field">
										<input class="mini input" type="number" value="${SoinsValue}"
											disabled>
									</div>
								</div>
								...
								<div class="two fields mini">
									...
									<div class="field">
										<input class="mini input" type="number"
											value="${AutresDepenseValue}" disabled>
									</div>
								</div>
								...
								<div class="two fields mini">
									...
									<div class="field">
										<input class="mini input" type="number"
											value="${AutresDepensePrive}" disabled>
									</div>
								</div>
								...
								<div class="two fields mini">
									...
									<div class="field">
										<input class="mini input" type="number" value="${totalG}"
											disabled>
									</div>
								</div>
								...
								<div class="two fields mini">
									<div class="field">
										<strong><label>Contribution du Client en (%)</label></strong>
									</div>
									<div class="field">
										<input class="mini input" type="number"
											value="${ContriClientDF}" disabled>
									</div>
								</div>
								-->
						...
						<div class="fields">
							<div class="four wide field">
								<label>Résidence actuelle depuis :</label> <input type="number"
									...
									value="${ResidenceActueldepuis}" min="0" step="0.01" required>
							</div>
					...
					<div class="ui blue segment">
						...
						<div class="ui grid">
							...
							<div class="eight wide column">
								...
								<div class="field">
									<label>Poste du conjoint</label> <input type="text"
							...
							<div class="eight wide column">
								...
								<div class="field">
									<label>Salarié depuis (mois)</label> <input type="number"
										...
										value="${AncieneteConjoinBoulot}" min="0" step="1" required>
								</div>
							...
							<div class="sixteen wide column">
								<div class="field">
									...
									<textarea name="CommentaireConjoin" rows="4" required>
${CommentaireConjoin}</textarea>
								</div>
							</div>
	...
	<div class="ui modal" id="exampleModal">
		...
		<div class="content">
			<h2 class="tw-text-lg tw-font-semibold tw-mb-2">Ajout membre de
				la famille</h2>
			<hr>
			<form class="ui form" action="InformationCompositionFamille.php"
				method="post">
				<div class="field">
					<label>Nom :</label> <input type="text" name="NomMF"
						placeholder="Nom" required>
				</div>
				<div class="field">
					<label>Age :</label> <input type="number" name="AgeMF"
						placeholder="Age" min="0" step="0.01" required>
				</div>
				<div class="field">
					<label>Lien de parenté :</label> <input type="text" name="LienMF"
						placeholder="Lien de parenté" required>
				</div>
				<div class="field">
					<label>Vit-il avec ?</label> <select name="localisationMF"
				...
				<div class="field">
					<label>Profession :</label> <input type="text" name="ProfessionMF"
			...
			<form class="ui form" action="InformationDepenseFamille.php"
				...
				<div class="fields">
					<div class="six wide column field">
						<label>Nourriture ($):</label> <input type="number"
							name="NourritureValue" min="0" step="0.01"
							value="${NourritureValue}" required>
					</div>

					<div class="six wide column field">
						<label>Combustible de cuisson ($):</label> <input type="number"
							name="CombustibleValue" min="0" step="0.01"
							value="${CombustibleValue}" required>
					</div>

					<div class="four wide column field">
						<label>Loyer ($):</label> <input type="number" name="LoyerValue"
							value="${LoyerValue}" required min="0" step="0.01">
					</div>
				...
				<div class="fields">
					<div class="six wide column field">
						<label>Transport ($):</label> <input type="number"
							name="TransportValue" value="${TransportValue}" required min="0"
							step="0.01">
					</div>

					<div class="six wide column field">
						<label>Communication ($):</label> <input type="number"
							name="CommunicationValue" value="${CommunicationValue}" required
							min="0" step="0.01">
					</div>

					<div class="four wide column field">
						<label>Habillement ($):</label> <input type="number"
							name="HabillementValue" value="${HabillementValue}" required
							min="0" step="0.01">
					</div>
				...
				<div class="fields">
					...
					<div class="six wide column field">
						<label>Education ($):</label> <input type="number"
							name="EducationValue" value="${EducationValue}" required min="0"
							step="0.01">
					</div>
					...
					<div class="four wide column field">
						<label>Soins médicaux ($):</label> <input type="number"
							name="SoinsValue" value="${SoinsValue}" required min="0"
							step="0.01">
					</div>
				...
				<div class="fields">
					...
					<div class="six wide column field">
						<label>Imprévus ($):</label> <input type="number"
							name="ImprevusValue" value="${ImprevusValue}" required min="0"
							step="0.01">
					</div>

					<div class="six wide column field">
						<label>Loisirs ($):</label> <input type="number"
							name="LoisirsValue" value="${LoisirsValue}" required min="0"
							step="0.01">
					</div>
				...
				<div class="field">
					<label>Autres dépenses privées ($):</label> <input type="number"
						name="AutresDepensePrive" value="${AutresDepensePrive}" required
						min="0" step="0.01">
				</div>

				<!--
				<div class="field">
					<label>Contribution du Client (%):</label> <input type="number"
						name="ContriClientDF" value="${ContriClientDF}" required min="0"
						max="100">
				</div>
				-->
				<button type="submit" class="ui primary button">Enregistrer</button>
