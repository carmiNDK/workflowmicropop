...
<body>
	...
	<div class="content">
							...
							<c:forEach items="${ListeAutreRevenuB2}" var="vk">
								<tr>
									...
									<td><c:if
											...
											<a class="ui mini red icon button btn-delete" data-id=""
												onclick="$('.ui.modifier-modal').modal('show');"
												data-url="SupInformationAutreRevenuBussness2.php?IdAutreRB2=${vk.idautresrevenub2}"><i
												class="trash icon"></i></a>
										</c:if></td>
					...
					<table class="ui very compact celled table">
						...
						<tr>
							...
							<td class="collapsing"><input type="number"
								...
								style="font-size: 10px;" name="MontantJanvierSV" required
								min="0" step="0.01"></td>
							<td class="collapsing"><input type="number"
		...
		<div class="ui modal" id="exampleModal2b2">
			...
			<div class="content">
				...
				<form class="ui form" action="InfoBussness2VenteMensuel.php"
					...
					<div class="field">
						<label>Montant Vendu :</label> <input type="number"
							name="MontantVM" id="qte" required min="0" step="0.01">
					</div>
					...
					<div class="fields">
						...
						<div class="eight wide column field">
							<label>Transport journalier au lieu de l'activité ($) :</label> <input
								...
								id="TransportJournalierLieuActivite" required
								value="${TransportJournalierLieuActiviteV}" min="0" step="0.01">
						</div>
						...
						<div class="eight wide column field">
							<label>Transport / coût de voyage d'achats ($) (fret,
								...
								required value="${TransportCoutVoyageAchatV}" min="0"
								step="0.01">
						</div>
					...
					<div class="fields">
						...
						<div class="six wide column field">
							<label>Loyer ($) :</label> <input type="number" name="LoyerDOP"
								id="LoyerDOP" required value="${LoyerDOPV}" min="0" step="0.01">
						</div>

						<div class="six wide column field">
							<label>Communication ($) :</label> <input type="number"
								name="communicationDOP" id="communicationDOP" required
								value="${communicationDOPV}" min="0" step="0.01">
						</div>

						<div class="four field">
							<label>Salaires ($) :</label> <input type="number"
								name="salaireDOp" id="salaireDOp" required
								value="${salaireDOpV}" min="0" step="0.01">
						</div>
					...
					<div class="fields">
						...
						<div class="eight wide column field">
							<label>Grandes dépenses d'investissement 6 derniers mois
								...
								id="depenseInvestsixmoisdernierDOP" required
								value="${depenseInvestsixmoisdernierDOPV}" min="0" step="0.01">
						</div>
		...
		<div class="ui modal" id="exampleModal2b200">
			...
			<div class="content">
				<h2 class="tw-text-lg tw-font-semibold tw-mb-2"
					style="margin-top: 15px;">Autres revenus</h2>
				<hr>
				<form class="ui form" action="InfoBussness2AutresRevenu.php"
					method="post">

					<div class="field">
						<label>Description-Activite :</label> <input type="text"
							name="DescriptionActivite" id="DescriptionActivite" required>
					</div>

					<div class="field">
						<label>Année-Depuis :</label> <input type="number"
							name="AnneeDepuis" id="AnneeDepuis" required min="0" step="0.01">
					</div>

					<div class="field">
						<label>Revenu-Mensuel :</label> <input type="number"
							name="RevenuMensuel" id="RevenuMensuel" required min="0"
							step="0.01">
					</div>
		...
		<script>
			$('#addVenteMensuelleMoyenne').click(function() {
				$('#exampleModal2b2').modal('show');
			});

			$('#addDepenses').click(function() {
				$('#exampleModal2b20').modal('show');
			});

			$('#addAutreRevenu').click(function() {
				$('#exampleModal2b200').modal('show');
			});
		</script>
