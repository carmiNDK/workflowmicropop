...
<body>
	...
	<div class="content">
		...
		<div class="tab-membres">
			...
			<form action="UpdateDemandeClientIL.php" method="post"
					...
					<div class="ui compact grid">
						...
						<div class="four wide column">
							<input name="NumCbsCliValue" type="number" id="NumCbsCliValue"
								style="width: 100%;" placeholder="0000000000"
								required="required" min="0" value="${NumCbsCliValue}"
								oninput="chercherClient()"
					...
					<div class="fields">
						<div class="six wide field">
							<label>Noms complet</label> <input type="text" name="NomCliValue"
								placeholder="Nom du client" value="${NomCliValue}" required>
						</div>
						<div class="six wide field">
					...
					<div class="fields">
						...
						<div class="six wide field">
							<label>Type d'identité</label> <select class="ui dropdown"
								name="TypePieceIdentiteDemandeurValue" required>
								<option selected>${TypePieceIdentiteDemandeurValue}</option>
					...
					<div class="fields">
						<div class="six wide field">
							<label>Sexe</label> <select class="ui dropdown"
								name="SexeDemandeurValue" required>
								<option selected>${SexeDemandeurValue}</option>
						...
						<div class="six wide field">
							<label>État civil</label> <select class="ui dropdown"
								name="EtatCivilCliDemandeurValue" onchange="toggleInput()"
								required>
								<option selected>${EtatCivilCliDemandeurValue}</option>
					...
					<div class="fields">
						...
						<div class="six wide field">
							<label>Noms (Conjoint(e))</label> <input type="text"
								name="NomsConjointCliDemandeurValue"
						...
						<div class="six wide field">
							<label>Date naissance conjoint</label> <input type="date"
								name="DateNaissanceConjoinDemandeurValue"
					...
					<div class="fields">
						...
						<div class="five wide field">
							<label>Téléphone(s) Conjoint</label> <input type="number"
								...
								value="${TelephoneConjointCliDemandeurValue}" maxlength="13">
						</div>
					</div>
							...
							<div class="button-container">
								<div class="col">
									<button type="submit" id="btnSave" class="ui primary button"
										<c:if test="${(sessionScope.Parcouror eq 'oui')||(sessionScope.EtatDossierCredit eq 'Assignation')||(sessionScope.EtatDossierCredit eq 'Comite')||(sessionScope.EtatDossierCredit eq 'Postage')||(sessionScope.clicking eq 'oui')}">
                                                                        disabled
                                                        </c:if>>Modifier</button>
								</div>
							</div>
						</div>
					</div>
	...
	<script>
		function toggleInput() {
			...
			var select = document.getElementById("etatcivilcli");
