...
<body>
				...
				<form action="InformationBussness1.php" method="post"
									...
									<tr>
										...
										<td><c:if
												...
												<a class="ui mini red icon button btn-delete" data-id=""
													...
													data-url="SupInformationAutresStock.php?numAS=${SPPA.idstockprincipal}"><i
													class="trash icon"></i></a>
											</c:if></td>
									</tr>
								</c:forEach>
								...
								<c:forEach items="${ListeAchatProduitPincipaux}" var="APPPS">
									<tr>
										...
										<td><c:if
												...
												<a class="ui mini red icon button btn-delete" data-id=""
													onclick="$('.ui.modifier-modal').modal('show');"
													data-url="SupInformationAchatPP.php?IdAchatPP=${APPPS.idapp}"><i
													class="trash icon"></i></a>
											</c:if></td>
									</tr>
								</c:forEach>
							...
							<div class="four wide column">
								<div class="ui input fluid ">
									<input type="number" id="point_vente" name="NbrPointVente"
										value="${NbrPointVente}" required min="0" step="0.01">
								</div>
							</div>
							...
							<div class="fields">
								...
								<div class="four wide field">
									<label>Créances</label> <input type="number" name="Creances"
										id="creance_business" value="${Creances}" required min="0"
										step="0.01">
								</div>
							</div>
							...
							<div class="fields">
								<div class="four wide field">
									<label>Véhicules</label> <input type="number" name="Vehicule"
										id="vehicules" value="${Vehicule}" required min="0"
										step="0.01">
								</div>
								<div class="four wide field">
									<label>Local commercial</label> <input type="number"
										name="LocalCommercial" id="local_commercial"
										value="${LocalCommercial}" required min="0" step="0.01">
								</div>
								<div class="four wide field">
									<label>Autres</label> <input type="number" name="Autres"
										id="autres" value="${Autres}" required min="0" step="0.01">
								</div>
					...
					<div class="ui blue segment">
						...
						<div class="ui form">
							<div class="fields">
								<div class="eight wide field">
									<label>Vente Baisse Saison ($)</label> <input type="number"
										name="VenteBaisseSaison" id="VenteBaisseSaison"
										value="${VenteBaisseSaison}" required min="0" step="0.01">
								</div>
							</div>
			...
			<form class="ui form" action="InfoBussness1StockPrincipal.php"
				...
				<div class="field">
					<label>Quantité :</label> <input type="number"
						name="QteProduitSpB1" min="0" step="0.01" required>
				</div>
				...
				<div class="field">
					<label>Prix d'achat :</label> <input type="number"
						name="PrixAchatB1" required min="0" step="0.01">
				</div>

				<div class="field">
					<label>Prix de vente :</label> <input type="number"
						name="PrixVenteb1" required min="0" step="0.01">
				</div>
	...
	<div class="ui modal" id="exampleModal1">
		...
		<div class="content">
			<h2 class="tw-text-lg tw-font-semibold tw-mb-2">Autres stocks</h2>
			<hr>
			<form class="ui form" action="InfoBussness1AutreStock.php"
				method="post">

				<div class="field">
					<label>Quantité :</label> <input type="number" name="QteProduitAS"
						required min="0" step="0.01">
				</div>

				<div class="field">
					<label>Produits :</label> <input type="text"
						name="LibelleProduitAS" required>
				</div>

				<div class="field">
					<label>Prix d'achat :</label> <input type="number"
						name="PrixAchatAS" required min="0" step="0.01">
				</div>

				<div class="field">
					<label>Prix de vente :</label> <input type="number"
						name="PrixVenteAS" required min="0" step="0.01">
				</div>
			...
			<form class="ui form" action="InfoBussness1AchatProdPrincipaux.php"
				...
				<div class="field">
					<label>Fréquence d'achat (mois) :</label> <input type="number"
						name="FrequenceMensuelle" id="freq" min="0" step="0.01" required>
				</div>

				<div class="field">
					<label>Quantité par achat :</label> <input type="number"
						name="QteParAchatA" id="qte" min="0" step="0.01" required>
				</div>
