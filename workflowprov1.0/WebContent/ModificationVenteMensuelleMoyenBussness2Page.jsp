	...
	<div class="content">
								...
								<tr>
									...
									<td><c:if
											...
											<a class="ui mini red icon button btn-delete" data-id=""
												href="SupInformationVenteMensuelleMoyen.php?IdVMM=${Vb.idventemensuelmoyen}"><i
		...
		<div class="ui modal" id="exampleModal2b2">
			<h2 class="tw-text-lg tw-font-semibold tw-mb-2"
				...
				Ventes Mensuelles Moyennes</h2>

			<div class="content">
				<form class="ui form" action="UpdateInfoBussness2VenteMensuel.php"
					method="post">

					<input type="hidden" name="IdVMM" value="${IdVMM}">

					<div class="field">
						<label>Libelle Mois :</label> <input type="text" id="LibelleMois"
							name="LibelleMois" required value="${LibelleMois}">
					</div>

					<div class="field">
						<label>Appreciation Vente :</label> <select name="Appreciation"
							id="Appreciation" required style="width: 100%;">
					...
					<div class="field">
						<label>Montant Vendu :</label> <input type="number" id="MontantVM"
							name="MontantVM" required value="${MontantVM}" min="0"
							step="0.01">
					</div>
				...
				<form class="ui form" action="InfoBussness2AutresRevenu.php"
					...
					<div class="field">
						<label>Année-Depuis :</label> <input type="number"
							name="AnneeDepuis" id="AnneeDepuis" required min="0">
					</div>

					<div class="field">
						<label>Revenu-Mensuel :</label> <input type="text"
							name="RevenuMensuel" id="RevenuMensuel" required>
					</div>
	...
	<div class="ui small modal modifier-modal">
		...
		<div class="actions">
			...
			<button type="button" class="ui green approve button"
				onclick="document.querySelector('#exampleModal2b2 form').submit();">
