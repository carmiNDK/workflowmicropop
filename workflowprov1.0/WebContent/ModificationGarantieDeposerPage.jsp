...
<body>
			...
			<form action="InfoGarant.php" method="post" class="ui form">
				<div class="ui blue segment">
					...
					<div class="ui grid">
						...
						<div class="four wide column">
							<input type="tel" id="telephone_mobile_garant" name="TelephoneG"
								value="${TelephoneG}" required>
						</div>
						...
						<div class="four wide column">
							<input type="tel" id="telephone_mobile_conjoint_garant"
						...
						<div class="four wide column">
							<input type="number" id="revenu_garant" name="RevenuG"
								value="${RevenuG}" required min="0">
						</div>

						<!-- Ligne 9 : Adresse -->
						<div class="four wide column">
							<label for="numero_residence_garant">Adresse :</label>
						</div>
						<div class="four wide column">
				...
				<div class="ui blue segment">
					...
					<div class="ui grid">
						...
						<div class="four wide column">
							<input type="text" id="CaffG" name="CaffG" value="${CaffG}">
						</div>
						...
						<div class="four wide column">
							<input type="text" id="CMVG" name="CMVG" value="${CMVG}">
						</div>
						...
						<div class="four wide column">
							<input type="text" id="TdOpG" name="TdOpG" value="${TdOpG}">
						</div>
						...
						<div class="four wide column">
							<input type="text" id="TotalAutresRevenusG"
						...
						<div class="four wide column">
							<input type="text" id="TotalDepensePriveG"
								name="TotalDepensePriveG" value="${TotalDepensePriveG}">
						</div>
				...
				<div class="ui blue segment">
					...
					<div class="ui grid">
						...
						<div class="four wide column">
							<input type="text" id="TotalAutreAvtG" name="TotalAutreAvtG"
								value="${TotalAutreAvtG}">
						</div>
						...
						<tr>
							...
							<td><c:if
									...
									<a class="ui mini red icon button btn-delete" data-id=""
										href="SupInformationGarantie.php?IdGarantie=${GGG.idgarantiedeposer}"><i
	...
	<!-- Semantic UI Modal -->
	<div class="ui modal" id="modalGarantie">

		<div class="ui header" style="margin-bottom: 10px; font-size: 14px;">Modification
			/ Information sur la garantie</div>
		<div class="content">
			<form class="ui form" action="UpdateInfoGarantie.php" method="post">
				<input type="hidden" name="IdGarantie" value="${IdGarantie}">
				<div class="field" style="margin-top: 10px;">
					<label>Type de garantie :</label> <select name="TypeGarantieGG"
						id="TypeGarantieGG" class="ui dropdown" required>
						<option selected>${TypeGarantieGG}</option>
						<option>AI</option>
						<option>AUTRE</option>
						<option>BM</option>
						<option>CDTG</option>
				...
				<div class="field">
					<label>Description :</label> <input type="text"
						name="DescriptionGG" id="DescriptionGG" required
						value="${DescriptionGG}">
				</div>

				<div class="field">
					<label>Année de fabrication :</label> <input type="number"
						name="AnneeFabrication" id="AnneeFabrication" required min="0"
						step="0.01" value="${AnneeFabrication}">
				</div>

				<div class="field">
					<label>Etat :</label> <select name="EtatGG" id="EtatGG"
						class="ui dropdown" required>
						<option selected>${EtatGG}</option>
				...
				<div class="field">
					<label>Prix d’achat :</label> <input type="number"
						name="PrixAchatGG" id="PrixAchatGG" required
						value="${PrixAchatGG}" min="0" step="0.01">
				</div>

				<div class="field">
					<label>Valeur marchande :</label> <input type="number"
						name="ValeurMarchandeGG" id="ValeurMarchandeGG" required
						value="${ValeurMarchandeGG}" min="0" step="0.01">
				</div>

				<div class="field">
					<label>Client/Garant :</label> <select name="ClientGarantGG"
						id="ClientGarantGG" class="ui dropdown" required>
						<option selected>${ClientGarantGG}</option>
				...
				<div class="actions"
					...
					<a href="GarantiePage.php" class="ui primary button"> Annuler </a>
					<button type="button"
	...
	<c:if test="${showModalDetails == true}">
		<script>
			$(document).ready(function() {
				$('#modalGarantie').modal({
					closable : false, // empêche de fermer en cliquant dehors
					allowEscapeKey : false
				// empêche ESC (équivalent Semantic)
				}).modal('show');
			});
		</script>
	</c:if>
	...
	<div class="ui small modal modifier-modal">
		...
		<div class="actions">
			...
			<button type="button" class="ui green approve button"
				onclick="document.querySelector('#modalGarantie form').submit();">
