...
<body>
	...
	<!-- Modal PRODUCTION -->
	<div class="ui small modal" id="exampleModal2b200200110">
		<!-- HEADER -->
		<div class="header">
			<div class="ui header"
				style="margin-bottom: 10px; font-size: 14px; margin-top: 10px;">Modification
				/ Production</div>
		</div>
		...
		<div class="content">
			<form class="ui form"
				action="UpdateInfoBussness3CoutProductionProd.php" method="post">

				<input type="hidden" name="numProd" value="${numProd}">

				<!-- Libellé produit -->
				<div class="field">
					<label>Libelle Produit :</label> <input type="text"
						id="LibelleProduitProductionProd"
						name="LibelleProduitProductionProd" required
						value="${LibelleProduitProductionProd}">
				</div>

				<!-- Nombre unité / mois -->
				<div class="field">
					<label>Nombre Unités Produit / Mois :</label> <input type="number"
						id="NbrUniteProduitProd" name="NbrUniteProduitProd" min="0"
						step="0.01" required value="${NbrUniteProduitProd}">
				</div>

				<!-- Prix vente par unité -->
				<div class="field">
					<label>Prix de Vente par Unité ($) :</label> <input type="number"
						id="PrixVenteParUniteProd" name="PrixVenteParUniteProd" required
						value="${PrixVenteParUniteProd}" min="0" step="0.01">
				</div>
	...
	<div class="ui small modal modifier-modal">
		...
		<div class="actions">
			...
			<button type="button" class="ui green approve button"
				onclick="document.querySelector('#exampleModal2b200200110 form').submit();">
