		...
		<div class="ui modal" id="exampleModal">
			...
			<div class="text">
				<h2 class="tw-text-lg tw-font-semibold tw-mb-2"
					style="padding-left: 50px; margin-top: 10px;">Modification
					Demande Prét GL</h2>
				<hr>
			...
			<hr>
			<div class="content">
				<form class="ui form" action="UpdateDossierMembreGroupeGL.php"
					method="post">
					...
					<div class="field">
						<label>DateDemande :</label> <input type="date"
							id="DateDemandeCliGL" name="DateDemandeCliGL" required
							value="${DateDemandeCliGL}">
					</div>

					<div class="two fields">
						<div class="field">
							<label>TotalEpargne ($) :</label> <input type="number"
								id="TotalEpargneCliGL" name="TotalEpargneCliGL" required
								value="${TotalEpargneCliGL}" min="0" step="0.01">
						</div>

						<div class="field">
							<label>DernierPrêt ($) :</label> <input type="number"
								id="DernierPretCliGL" name="DernierPretCliGL" required min="0"
								step="0.01" value="${DernierPretCliGL}">
						</div>
					</div>
					...
					<div class="field">
						<label>FraisAssurance ($) :</label> <input type="number"
							...
							value="${FraisAssuanceCliGL}" min="0" step="0.01">
					</div>

					<div class="actions"
						style="background: #f9f9f9; padding: 15px; border-top: 1px solid #ddd; margin-top: 20px;">
						<a href="DemandePretGL.php" class="ui primary button"> Annuler
						</a>
						<button type="button"
