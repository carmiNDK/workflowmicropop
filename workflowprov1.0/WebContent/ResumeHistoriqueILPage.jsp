		...
		<div class="content-with-nav">
			<div class="content-nav">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					...
					<li id="menuResumeProposition" class="nav-item" role="presentation"><a
						href="ResumeHistoriqueILPage.php" class="nav-link active"
						type="button" role="tab" aria-selected="false">Historique</a></li>
		...
		<div class="tab-membres">
			...
			<div class="ui blue segment">
				<h2 class="tw-text-lg tw-font-semibold tw-mb-2">Cash Flow
					(Cycle Précédent)</h2>
				<hr>
				<form action="CalculerIndicateurHistoriqueCyclePrecedent.php"
					method="post" class="ui form">
					<table class="ui table">
						<tr>
							<td>Chiffre d'affaires/Ventes ($)</td>
							<td><input type="number" id="chiffre_affaire"
								style="width: 100%;" disabled value="${chiffrecaffrdc}"></td>
							<td><select class="ui mini dropdown" name="CAAHC" id="CAAHC"
						...
						<tr>
							...
							<td><input type="number" id="cout_marchandise_vendue"
								style="width: 100%;" value="${camvrdc}" disabled></td>
						...
						<tr>
							...
							<td><input type="number" id="profit_brut"
								style="width: 100%;" disabled value="${profitbrutrdc}">
							<td></td>
							<td></td>
						</tr>
						...
						<tr>
							...
							<td><input type="number" id="depenses_operationnelles"
								style="width: 100%;" disabled value="${depenseoprdc}">
							<td></td>
							<td></td>
						</tr>
						...
						<tr>
							...
							<td><input type="number" id="profit_net"
								style="width: 100%;" disabled value="${profitnetrdc}">
							<td></td>
							<td></td>
						</tr>
						...
						<tr>
							...
							<td><input type="number" id="autres_revenus_net"
								style="width: 100%;" disabled value="${autrerevenunetrdc}">
							<td></td>
							<td></td>
						</tr>
						<tr>
							...
							<td><input type="number" id="total_depenses_privees"
								style="width: 100%;" disabled value="${totaldepensepriverdc}">
							<td></td>
							<td></td>
						</tr>
			...
			<div class="ui blue segment">
				...
				<h2 class="tw-text-lg tw-font-semibold tw-mb-2">Bilan (Cycle
					Précédent)</h2>
				<hr>
			...
			<div class="ui blue segment">
				<hr style="margin-top: 15px;"]>
				<h2 class="tw-text-lg tw-font-semibold tw-mb-2">RATIOS (Cycle
					Précédent)</h2>
				<hr>
				<div class="ui grid">
					<div class="nine wide column">
						<table class="ui table">
							...
							<tr>
								...
								<td><input type="number" id="endettement_ratio"
									style="width: 100%; color: rgb(151, 12, 231);"
									value="${ratioendtrdc}" disabled></td>
								<td><span><= 0.5</span></td>
							</tr>
