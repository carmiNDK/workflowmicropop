				...
				<table class="ui celled table" id="tabUniteFamiliale">
					<thead>
						...
						<tr>
							...
							<th><label for=""><strong>AdresseDomicile</strong></label></th>
					...
					<tbody>
						<c:forEach items="${ListeMembreGroupeGL}" var="MembreGroupe">
							<tr>
								...
								<td>${MembreGroupe.adressemembregroupe}</td>
								...
								<td><c:if
										test="${(sessionScope.etatGroupGL eq 'Creation') || (sessionScope.etatGroupGL eq 'Analyse') || (sessionScope.etatGroupGL eq 'Verification')}">
		...
		<div class="ui fullscreen modal" id="exampleModal"
			...
			<div class="text">
				<h2 class="tw-text-lg tw-font-semibold tw-mb-2"
					...
					<i class="users icon"></i> Ajout membre groupe lisanga
				</h2>
				<hr>
			</div>
			<div class="scrolling content" style="max-height: 90vh;">
				<form class="ui form" action="CreationMembreGroupeGL.php"
					...
					<div class="ui grid form-grid">
								...
								<div class="column">
									...
									<div class="field">
										<label class="required-field">Telephone :</label> <input
											type="number" id="TelephoneMembreGroupe1"
								...
								<div class="column">
									...
									<div class="field">
										<label class="required-field">EtatCivil :</label> <select
											class="ui dropdown" id="EtatCivilMembreGroupe"
											name="EtatCivilMembreGroupe" required>
											<option value="">Sélectionner</option>
								...
								<div class="column">
									...
									<div class="field">
										<label class="required-field">Catégorie Membre :</label> <select
											id="CategorieMembreGroupe" name="CategorieMembreGroupe"
											required>
											<option value="">Sélectionner</option>
									...
									<div class="field">
										<label class="required-field">Transfert Membre :</label> <select
											id="TransfertMembreGroupe" name="TransfertMembreGroupe"
											required>
											<option value="">Sélectionner</option>
											<option>Non</option>
											<option>Oui</option>
						...
						<div class="four wide column">
							<div class="photo-upload-section"
								...
								<h3 class="text">
									<i class="image icon"></i> Photo du Membre
								</h3>
								<div class="photo-preview" id="photoPreview"
									style="width: 180px; height: 180px; border-radius: 50%; overflow: hidden; border: 1px solid #ddd; background: #f7f7f7; display: flex; align-items: center; justify-content: center;
	/* CENTRAGE */ margin: 0 auto;">
									<div class="placeholder">
										<i class="user icon" style="font-size: 2em;"></i>
										<div style="margin-top: 10px;">Aperçu de la photo</div>
									</div>
									<img id="previewImage" src="" alt="Aperçu de la photo">
								</div>

								<div class="field">
									<label for="PhotoMembreGroupe"> <i
										class="file image icon"></i> Choisir une photo
									</label> <input type="file" id="PhotoMembreGroupe"
										name="PhotoMembreGroupe" accept="image/*" required
								...
								<div class="ui segment">
									...
									<div class="ui list">
										<div class="item">
											...
											<div class="content">Format: JPG, PNG</div>
										</div>
										<div class="item">
											<i class="check circle icon"></i>
											<div class="content">Taille max: 2MB</div>
										</div>
										<div class="item">
											<i class="check circle icon"></i>
											<div class="content">Photo récente</div>
										</div>
										<div class="item">
											<i class="check circle icon"></i>
											<div class="content">Photo portrait</div>
										</div>
									</div>
								</div>
								...
								<div class="ui success message">
									...
									<p>Choisissez une photo claire et récente pour une
										identification facile.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="actions"
						...
						<button type="submit"
							...
							<i class="checkmark icon"></i> Enregistrer le membre
						</button>
					</div>
				</form>
			</div>
