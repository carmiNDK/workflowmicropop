...
<body>
									...
									<tr>
										...
										<td><c:if
												...
												<a class="ui mini red icon button btn-delete" data-id=""
													href="SupInformationEvaluationStock.php?numESP=${SPP.idstockprincipal}"><i
	...
	<div class="ui modal" id="exampleModal">
		<h2 class="tw-text-lg tw-font-semibold tw-mb-2"
			...
			Evaluation Stock des Produits</h2>

		<div class="content">
			<form class="ui form" action="UpdateInfoBussness1StockPrincipal.php"
				method="post">

				<input type="hidden" id="numESP" name="numESP" value="${numESP}">

				<div class="field">
					<label>Quantité :</label> <input type="number" id="QteProduitSpB1"
						name="QteProduitSpB1" required min="0" step="0.01"
						value="${QteProduitSpB1}">
				</div>

				<div class="field">
					<label>Produits :</label> <input type="text" id="LibelleProduitB1"
						name="LibelleProduitB1" required value="${LibelleProduitB1}">
				</div>

				<div class="field">
					<label>Prix d'achat :</label> <input type="number" id="PrixAchatB1"
						name="PrixAchatB1" required value="${PrixAchatB1}" min="0"
						step="0.01">
				</div>

				<div class="field">
					<label>Prix de vente :</label> <input type="number"
						id="PrixVenteb1" name="PrixVenteb1" required
						value="${PrixVenteb1}" min="0" step="0.01">
				</div>

				<div class="field">
					<label>Observation :</label> <select class="ui dropdown"
						id="ObservationSPB1" name="ObservationSPB1" required>
						<option selected>${ObservationSPB1}</option>
	...
	<div class="ui modal" id="exampleModal1">
		...
		<div class="content">
			...
			<form class="ui form" action="InfoBussness1AutreStock.php"
				...
				<div class="field">
					<label>Prix d'achat :</label> <input type="text" name="PrixAchatAS"
						required>
				</div>

				<div class="field">
					<label>Prix de vente :</label> <input type="text"
						name="PrixVenteAS" required>
				</div>
