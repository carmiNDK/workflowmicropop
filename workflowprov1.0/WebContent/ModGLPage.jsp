...
<body>
						...
						<div class="twelve wide column">
							<div class="ui input fluid">
								<input type="text" id="NomsResponsableRisqueGL"
									...
									value="${NomsResponsableRisqueGL}" required>
							</div>
						</div>
					</div>
				...
				<div class="ui grid">
					...
					<div class="six wide column">
						<input type="text" name="DecideurComiteGLCom"
							id="DecideurComiteGLCom" style="width: 100%;" required="required"
							value="${DecideurComiteGLCom}">
					</div>
	...
	<div class="ui modal" id="exampleModal">
		<div class="header">Modification Montant prêt GL</div>

		<div class="content">
			<form class="ui form" action="ModificationMontantPretGL.php"
				method="post">
				...
				<div class="actions"
					...
					<a href="ComiteGL.php" class="ui primary button"> Annuler </a>
					<button type="button"
