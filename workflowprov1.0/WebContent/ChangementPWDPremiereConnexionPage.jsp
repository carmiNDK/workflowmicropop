...
<title>KwikLoan : Premiére Connexion</title>
</head>
...
<body>
					...
					<div class="ui dropdown item agent-dropdown">
						<div class="ui minimal compact"
							...
							<div class="agent-info"
								...
								<div style="font-weight: 600; font-size: 1em;"></div>
								<div style="font-size: 0.8em; color: #83a2c6;"></div>
							</div>
	...
	<div class="content">
		...
		<div class="ui modal  form-modal" id="exampleModal2025">
			...
			<div class="content">
				<form class="ui form" action="AuthentificationUser.php"
					method="post">
					...
					<div class="form-section">
						<div class="section-title">
							<i class="user icon"></i>Changement Mot de Passe (Premiére
							connexion)
						</div>
					...
					<div class="actions"
						...
						<a href="Login.jsp" class="ui primary button"> Annuler </a>
						<button type="button"
