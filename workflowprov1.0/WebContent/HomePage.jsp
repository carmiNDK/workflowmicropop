...
<title>KwikLoan : Tableau de board</title>
</head>
				...
				<div class="input">
					<div class="ui dropdown item agent-dropdown">
						...
						<div class="menu" style="width: 280px;">
							...
							<a class="item" href="GetGuiModificationMotPasseUtilisateurs.php">
								<i class="key icon"></i> Changer mot de passe
							</a>
						...
						<table id="loans" class="ui celled table">
							<thead>
								<tr>
									...
									<th scope="col">Nombre(Etape Termine)</th>
