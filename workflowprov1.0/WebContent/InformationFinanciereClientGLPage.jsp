	...
	<div class="content">
					...
					<tbody>
						<c:forEach items="${ListeInformationFinancireClientGL}" var="SPP">
							<tr>
								...
								<td><c:if
										test="${(sessionScope.etatGroupGL eq 'Evaluation') || (sessionScope.etatGroupGL eq 'Analyse')|| (sessionScope.etatGroupGL eq 'Comite')}">
		...
		<div class="ui modal" id="exampleModal">
			...
			<div class="scrolling content">
				...
				<hr>
				<form class="ui form"
					action="EnregistrementInfoFinanciereClientGL.php" method="post">
					<div class="fields">
						...
						<div class="eight wide column field">
							<label>MontantEpargne [Reunion] ($) :</label> <input
								type="number" id="MontantEpargneReunionGL" min="0" step="0.01"
								name="MontantEpargneReunionGL" required />
						</div>
					</div>
					...
					<div class="field">
						...
						<textarea name="commentaireInfoFinanciereCliGL"
							id="commentaireInfoFinanciereCliGL" rows="6" required></textarea>
					</div>
		...
		<c:if test="${NDEKE eq 'okok'}">
			<script>
				Swal.fire({
					title : 'Message !',
					text : 'La modification effectuer avec succès !!!',
					icon : 'succes',
