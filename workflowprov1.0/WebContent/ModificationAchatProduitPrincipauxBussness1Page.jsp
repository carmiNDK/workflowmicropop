...
<body>
	...
	<div class="ui modal" id="exampleModal2">
		<h2 class="tw-text-lg tw-font-semibold tw-mb-2"
			...
			Achat produits principaux</h2>

		<div class="content">
			<form class="ui form"
				action="UpdateInfoBussness1AchatProdPrincipaux.php" method="post">
				...
				<div class="field">
					<label>Produits principaux :</label> <select
						...
						<option selected>${LibelleProduitPrincipaux}</option>
				...
				<div class="field">
					<label>Fréquence d'achat (mois)</label> <input type="number"
						id="freq" name="FrequenceMensuelle" required min="0" step="0.01"
						value="${FrequenceMensuelle}">
				</div>

				<div class="field">
					<label>Quantité par achat</label> <input type="number" id="qte"
						name="QteParAchatA" required min="0" step="0.01"
						value="${QteParAchatA}">
				</div>
	...
	<div class="ui small modal modifier-modal">
		...
		<div class="actions">
			...
			<button type="button" class="ui green approve button"
				onclick="document.querySelector('#exampleModal2 form').submit();">
