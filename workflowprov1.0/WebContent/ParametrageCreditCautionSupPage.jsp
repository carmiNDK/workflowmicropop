...
<title>KwikLoan : Paramètrage caution</title>
</head>
				...
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					...
					<li id="menuBussness1" class="nav-item" role="presentation"><a
						...
						type="button" role="tab" aria-selected="false">Paramètres -
							Assurances</a></li>
					<li id="menuBussness1" class="nav-item" role="presentation"><a
						href="ParametrageCautionSupPage.php" class="nav-link active"
						type="button" role="tab" aria-selected="false">Paramètres -
							Cautions</a></li>
				</ul>
			</div>
		...
		<div class="page-content">
			...
			<div class="ui blue segment">
				<h2 class="tw-text-lg tw-font-semibold tw-mb-2">Configuration
					Caution Supplementaire / Produit Crédit IL</h2>
				<hr>
				<form class="ui form"
					action="ModificationCautionDossierCreditIL.php" method="post">

					<div class="two fields">
						<div class="field">
							<label>Numéro dossier de crédit </label> <input type="text"
								class="form-control" id="NuMeroDossierCreditIL"
								name="NuMeroDossierCreditIL" required="required"
								value="${NuMeroDossierCreditIL}"></input>
						</div>

						<div class="field">
							<label>TauxCautionModifier</label> <input type="number"
								class="form-control" id="TauxCautionModifierPoste"
								name="TauxCautionModifierPoste" required="required"
								value="${TauxCautionModifierPoste}" min="0" step="0.01"></input>
						</div>
					</div>
