...
<body>
	...
	<div class="content">
						...
						<c:forEach items="${ListeInformationBussenessClientGL}" var="SPP">
							<tr>
								...
								<td><a href="javascript:void(0)"
									title="Photos du Bunnsess Client"
									onclick="openClientModal(${SPP.idbussnessglb})"><i
		...
		<div class="ui modal" id="exampleModal">
			...
			<div class="content">
				<h2 class="tw-text-lg tw-font-semibold tw-mb-2"
					style="margin-top: 15px;">Information Bussness Client GL</h2>
				<hr>
				<form class="ui form" action="EnregistrementBussnessClientGL.php"
					...
					<div class="field">
						<label for="PhotoMembreGroupe"> <i class="file image icon"></i>
							Choisir une photo du Bussness Membre
						</label> <input type="file" id="PhotoBussnessMembreGroupe"
							name="PhotoBussnessMembreGroupe" accept="image/*" required
					...
					<div class="field">
						...
						<textarea name="commentaireBussnessCliGL"
							id="commentaireBussnessCliGL" rows="5" required></textarea>
					</div>
		...
		<c:if test="${Souzy eq 'kitokoMaFemme'}">
			<script>
				Swal.fire({
					title : 'Message !',
					text : 'Le bussness est modifier avec succès !!!',
					icon : 'succes',
		...
		<script>
			function openClientModal(idbussnessglb) {
				document.getElementById('clientModalImg').src = 'VisualisationDocumentBussnessGL.php?numbussnessm='
						+ idbussnessglb;
